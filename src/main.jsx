...
const App = () => {
  ...
  useEffect(() => {
    ...
    return () => { 
      ...
      if (rendererRef.current && rendererRef.current.domElement && containerRef.current) containerRef.current.removeChild(rendererRef.current.domElement);
      renderer.dispose(); 
    };
  }, []);
